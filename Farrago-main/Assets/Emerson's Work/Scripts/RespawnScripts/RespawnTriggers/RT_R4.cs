...
public class RT_R4 : RespawnTrigger
{
    ...
    {
        timelineLevelSc.ResetCutscene(CutSceneTypes.Level4RatCage);
        // open rat spawner
        ratSpawnerCollection.spawnerCollection[RatSpawnerArea.R4_0].SetActive(true);
        ratSpawnerCollection.spawnerCollection[RatSpawnerArea.R4_1].SetActive(true);
        ratSpawnerCollection.spawnerCollection[RatSpawnerArea.R3].SetActive(false);
    }
